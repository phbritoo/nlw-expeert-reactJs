...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
      ...
      const handleStartRecording = () => {
            ...
            if (!isSpeechRecognitionAPIAvailable) {
                  alert("Browser not supported! Try other browser, please! ")
                  return
            }
            setIsRecording(true)
            setShouldShowOnBoarding(false)
      ...
      return (
            <Dialog.Root>
                  <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2 hover:slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
                                                ...
                                                {shouldShowOnBoarding ? (
                                                      <p className="text-sm leading-6 text-slate-400">
                                                            ...
                                                            <button type="button" className="font-medium text-lime-400 hover:underline" onClick={handleStartRecording}>
                                                                  recording an audio note </button> or if you prefer,
